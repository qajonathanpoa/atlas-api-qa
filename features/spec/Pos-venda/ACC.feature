...
Funcionalidade: Informar que o meu pedido teve um atraso na coleta de caso critico
    ...
    @PV34-003
    Esquema do Cenario: Pagamento aprovado PV34-003
        ...
        Exemplos:
            | id_entrega  | id_pedido | ponto_controle | unidade_negocio | aplicabilidade | id_forma_pagamento | id_tipo_entrega | tipo_venda |
            | 35540573402 | 355405734 | ACC            | 8               | PV34-003        | 12                 | 15              | B2C        |
            | 35730443904 | 357304439 | ACC            | 1               | PV34-003        | 12                 | 15              | B2C        |
            

@PV34-001
    Esquema do Cenario: Pagamento aprovado PV34-001
        ...
        Exemplos:
            | id_entrega  | id_pedido | ponto_controle | unidade_negocio | aplicabilidade | id_forma_pagamento | id_tipo_entrega | tipo_venda |
            #| 35540573402 | 355405734 | ACC            | 8               | PV34-003        | 12                 | 15              | B2C        |
            | 21822751402 | 218227514 | ACC            | 1               | PV34-001        | 12                 | 15              | B2C        |
